...
import com.segment.analytics.edgefn.kotlin.EdgeFunctionsController
...
class DestinationFilters : Plugin {
    ...
    override fun setup(analytics: Analytics) {
        ...
        val edgeFn: EdgeFunctionsController = analytics.find(EdgeFunctionsController::class) ?: run {
            with(EdgeFunctions()) {
                analytics.add(this)
                this.controller // return newly constructed EdgeFunctions
            }
        }
